  ...
  const installMouser = (theCanvas) => {
    ...
    function doMouseUp(evt) {
      ...
      if (
        ...
        setItemsRef((prevItems) =>
          Array.isArray(prevItems) ? [...prevItems, dragItemRef.current] : []
        );
  ...
  return (
    <div>
      <div>
        ...
        <Canvas ref={OcanvasRef} width={800} height={600} id="c2" />
      </div>
      <div>
      ...
      <div>
        ...
        <button onClick={clearCanvas} id="clear">
          Clear Canvas
        </button>
      </div>
      <div>
