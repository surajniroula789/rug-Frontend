...
const CanvasRosette = () => {
  ...
  useEffect(() => {
    ...
    const storedImage = localStorage.getItem("rosetteImage");
  ...
  const drawImage = (offsetX, offsetY) => {
    ...
    img.src = localStorage.getItem("rosetteImage");
  };
  ...
  return (
    <>
      ...
      <br />
      <div className="flex justify-center items-center mt-28 h-15">
        <Canvas
          ref={canvasRef}
          width={300}
          height={300}
